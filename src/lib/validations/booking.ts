...
export const bookingSchema = z
  ...
  .refine(
    (data) => {
      // Custom validation for password when createAccount is true
    ...
    {
      message:
        "Przy tworzeniu konta hasło jest wymagane (min. 6 znaków) i potwierdzenie hasła musi być identyczne",
